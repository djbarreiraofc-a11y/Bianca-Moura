const services = [
  ...
  },
  {
    name: 'Volume Fox',
    price: 'R$ 165,00',
    image: '/images/whatsapp_image_2025-12-16_at_20.45.05.jpeg',
  },
  {
    name: 'Volume Fox Marrom',
    price: 'R$ 165,00',
    image: '/images/whatsapp_image_2025-12-16_at_20.45.05_(1).jpeg',
  },
  {
    name: 'Volume Europeu',
    price: 'R$ 165,00',
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-3xl font-light text-[#8B7355]">
            Galeria de Serviços
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Texto normal */}
              <div className="p-6">
                <h3 className="text-lg font-light text-[#8B7355] mb-2">
                  {service.name}
                </h3>
                <p className="text-xl font-medium text-[#2D5F3F]">
                  {service.price}
                </p>
              </div>
            </div>
